...
import static com.example.tranquoctrungcntt.uchat.AppUtils.GetterUtils.getEmojiFoods;


/**
 * A simple {@link Fragment} subclass.
 */
public class FoodEmojiFragment extends Fragment {


    public FoodEmojiFragment() { }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_foods_emoji, container, false);
        ...
        EmojiAdapter adapter = new EmojiAdapter(getActivity(), foods, new AppConstants.AppInterfaces.OnAdapterItemClickListener() {
            @Override
            public void OnItemClick(View v, int position) {
                if (getActivity() instanceof UpdateStatus) {

                    UpdateStatus mParentActivity = (UpdateStatus) getActivity();
                    mParentActivity.appendEmoji(foods.get(position));
        ...
        RecyclerView rv_foods = (RecyclerView) view.findViewById(R.id.rv_foods_emoji);

        rv_foods.setHasFixedSize(true);
        rv_foods.setLayoutManager(new GridLayoutManager(getActivity(), 7, GridLayoutManager.VERTICAL, false));
        rv_foods.setItemAnimator(null);
